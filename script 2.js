...
const storageKey = 'ecoplanner.tasks.v1';
let tasks = [];
...
function seedIfEmpty() {
  ...
  tasks = [
    ...
    { id: uid(), title: 'Separar lixo reciclável', done: false, cat: 'Casa', due: '', prio: 'Alta', notes: '', sust: true },
    { id: uid(), title: 'Ir de bicicleta para a escola', done: false, cat: 'Transporte', due: '', prio: 'Baixa', notes: 'Se chover, usar ônibus.', sust: true },
  ];
  save();
}
